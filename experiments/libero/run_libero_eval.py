...
class GenerateConfig:
    ...
    long: bool=False 
    unnorm_key: Optional[str] = None                 # Key for action un-normalization statistics
    #################################################################################################################
    ...
    local_log_dir: str = "/data/syh/nora/experiments/logs"        
...
def eval_libero(cfg: GenerateConfig) -> None:
    ...
    print(f"cfg.unnorm_key: {cfg.unnorm_key}\n\n\n")
    # Load model
    # if cfg.long:
    ...
    nora = Nora('declare-lab/nora-finetuned-libero-object')
