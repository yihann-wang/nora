...
class GenerateConfig:
    ...
    local_log_dir: str = "/data/yangyi/nora/experiments/logs"        
...
def eval_libero(cfg: GenerateConfig) -> None:
    ...
    nora = Nora('declare-lab/nora-finetuned-libero-spatial')
        ...
        for episode_idx in tqdm.tqdm(range(cfg.num_trials_per_task)):
            ...
            while t < max_steps + cfg.num_steps_wait:
                try:
                    ...
                    action = nora.inference(observation["full_image"], task_description, unnorm_key=cfg.unnorm_key)
